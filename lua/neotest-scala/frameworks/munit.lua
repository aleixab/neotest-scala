...
local fw_utils = require("neotest-scala.frameworks.utils")
...
local function build_command(runner, project, tree, name, extra_args)
    ...
    return fw_utils.build_command_with_test_path(project, runner, test_path, extra_args)
end
...
local function get_test_results(output_lines)
    ...
    for _, line in ipairs(output_lines) do
        line = vim.trim(fw_utils.strip_ainsi_chars(line))
