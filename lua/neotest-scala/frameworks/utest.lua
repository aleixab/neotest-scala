local framework_utils = require('neotest-scala.frameworks.framework_utils')
local utils = require('neotest-scala.frameworks.utils')
...
local function utest_framework()
    ...
    local function build_command(runner, project, tree, name, extra_args)
        ...
        return framework_utils.build_command_with_test_path(project, runner, test_path, extra_args)
    end
    ...
    local function get_test_results(output_lines)
        ...
        for _, line in ipairs(output_lines) do
            line = framework_utils.strip_ainsi_chars(line)
